...
FEW_SHOT_CONTEXT = """Below are examples of customer feedback classification:
product_quality: "The spray head on this perfume bottle was broken."
staff_service: "The sales assistants were incredibly friendly and helpful."
pricing: "The tax-free prices are higher than downtown shops."
store_experience: "The store was crowded and the aisle spacing was too narrow."
checkout_process: "There was a long queue at the cash registers during transit rush."
stock_availability: "They did not have the 100ml size of Chanel No 5 in stock."
tax_free_refund: "The customs validation counter was hard to find for my tax stamp."
loyalty_program: "My member points were not added to my account today."
store_cleanliness: "There was spilled liquid on the cosmetics aisle floor."
website_preorder: "My airport pick-up collection order was missing two items."

Now, classify this customer feedback:
"{text}"
"""
...
def run() -> dict:
    ...
    return build_result(
        ...
        type=TASK_TYPE,
        description="Categorise customer feedback using custom hypotheses and a 10-class few-shot context.",
